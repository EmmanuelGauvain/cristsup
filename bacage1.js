...
longueur = bacpop.length;

long2 = longueur*1+1

for (var i = 1; i < long2; i++){
    bacpop.push(new Bacteria(longueur+i, 0, 0));
}
...
for (var i = 0; i < longueur; i++){
    ...
    bacpop[i].damage = firstdam*1+100;
    firstdam = bacpop[i].damage
}

premierdam = bacpop[0].damage
trentedam = bacpop[30].damage

document.getElementById("cres1").innerHTML = "First bacteria damage : "+premierdam+" et "+trentedam;
